...
# A support allows us to clamp any sort of value such as a node value
# or reward to keep it in range, similar to the MinMaxBounds presented
# in the MuZero paper. We will have differentb bounds for value and reward
# than just reward
...
class BaseMuZeroConfig(object):
    def __init__(self, 
        ...
        # If we already have some information about which values according to the environemnet
        # we can use them to rescale. This is not strictly neccesary however, but establises
        # idedntial behavior to AlphaZero in board game
        ...
        self.lr_decary_rate = lr_decay_rate
    ...
    def new_game(self, seed=None, save_video=False, save_path=None, video_callable=None, uid=None) -> Game:
        """ returns a new instance of the game that we wish to utilize """
        raise NotImplementedError
    ...
    def inverse_scalar_transform(self, logits, scalar_support):
        """ Reference : Appendix F => Network Architecture
        & Appendix A : Proposition A.2 in https://arxiv.org/pdf/1805.11593.pdf"""
    ...
    def set_config(self, args):
        ...
        self.seed = args.seed
        self.priority_prob_alpha = 1 if args.priority_prob_alpha else 0
