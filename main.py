...
if __name__=="__main__":
    ...
    parser.add_argument('--case', required=True, choices=['atari', 'classic_control'], help="Choose which environment sandbox that which you wish to train a model on domains (default: %(default)s)")
